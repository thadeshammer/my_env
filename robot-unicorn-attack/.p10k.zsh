# Generated by Powerlevel10k configuration wizard on 2023-11-11 at 15:39 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42599.
# Wizard options: compatible, rainbow, unicode, 12h time, blurred heads, blurred tails,
# 2 lines, dotted, no frame, light-ornaments, sparse, fluent, transient_prompt,
